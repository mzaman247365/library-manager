...
async function main() {
  console.log("Starting sample books creation...");
  ...
  try {
    ...
    if (existingBooks.length === 0) {
      ...
      console.log(`Added ${insertedBooks.length} sample books.`);
    } else {
      console.log(`${existingBooks.length} books already exist in the database. Skipping sample books creation.`);
    }
    
    console.log("Sample books creation process completed.");
  } catch (error) {
